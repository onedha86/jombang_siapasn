...
<head>
	...
	<script type="text/javascript" charset="utf-8">
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 25,
        	...
        	"bProcessing": true,
        	"bServerSide": true,
        	"sAjaxSource": "kenaikan_gaji_berkala_json/json?reqAkses=<?=$reqAkses?>&reqMode=proses&reqBulan=<?=$reqBulan?>&reqTahun=<?=$reqTahun?>",
        	"sScrollX": "100%",								  
        	"sScrollXInner": "100%",
        ...
        $('#btnProses').on('click', function () {
		 ...
		 //  oTable.fnReloadAjax("kenaikan_gaji_berkala_json/json?reqMode=proses&reqSatuanKerjaId="+reqSatuanKerjaId+"&reqStatusKgb="+reqStatusKgb+"&reqPangkatId="+reqPangkatId+"&reqBulan="+reqBulan+"&reqTahun="+reqTahun+"&sSearch="+reqCariFilter);
		...
		$("#btnCari").on("click", function () {
			...
			oTable.fnReloadAjax("kenaikan_gaji_berkala_json/json?reqAkses=<?=$reqAkses?>&reqMode=proses&reqSatuanKerjaId="+reqSatuanKerjaId+"&reqStatusKgb="+reqStatusKgb+"&reqJenisKgb="+reqJenisKgb+"&reqPangkatId="+reqPangkatId+"&reqBulan="+reqBulan+"&reqTahun="+reqTahun+"&sSearch="+reqCariFilter);
		});
		  
		/*$('#btnKgbLengkapRowPersonal').on('click', function () {
			  // openModal('app/loadUrl/persuratan/tanda_tangan_pilih_badan?reqPegawaiId='+anSelectedId+'&reqSatuanKerjaId=66&reqMode=kgb1');
			  var url= 'kenaikan_gaji_berkala_cetak_sk_rpt.php?reqJenis=1&reqBulan='+$("#reqBulan").val()+'&reqTahun='+$("#reqTahun").val()+'&reqPegawaiId='+anSelectedId;
		...
		$('#btnKgbLengkapRowPersonal').on('click', function () {
			  ...
			  reqTahun= $("#reqTahun").val();
			  // openModal('app/loadUrl/persuratan/tanda_tangan_pilih_badan?reqPegawaiId='+anSelectedId+'&reqSatuanKerjaId=66&reqMode=kgb1');
			  var url= 'template?reqJenis=1&reqBulan='+reqBulan+'&reqTahun='+reqTahun+'&reqJenisKgb='+reqJenisKgb+'&reqPegawaiId='+anSelectedId+'&reqLink=kenaikan_gaji_berkala_cetak_sk_pdf';
			  // var url= 'kenaikan_gaji_berkala_cetak_sk_rpt.php?reqJenis=1&reqBulan='+reqBulan+'&reqTahun='+reqTahun+'&reqJenisKgb='+reqJenisKgb+'&reqPegawaiId='+anSelectedId;
		...
		$('#btnKgbLengkapRowKolektif').on('click', function () {
			  ...
			  reqBulan= $("#reqBulan").val();
			  reqTahun= $("#reqTahun").val();
			  // var url= "kenaikan_gaji_berkala_cetak_sk_rpt.php?reqSatuanKerjaId="+reqSatuanKerjaId+"&reqJenis=1&reqBulan="+ reqBulan + '&reqTahun=' + reqTahun+'&reqJenisKgb='+reqJenisKgb;
			  var url= "template?reqSatuanKerjaId="+reqSatuanKerjaId+"&reqJenis=1&reqBulan="+ reqBulan + '&reqTahun=' + reqTahun+'&reqJenisKgb='+reqJenisKgb+'&reqLink=kenaikan_gaji_berkala_cetak_sk_pdf';		
			  newWindow = window.open("app/loadUrl/report/"+url, 'Cetak');
			  newWindow.focus();	
		});
		...
		$('#btnKgbTandaTerima').on('click', function () {	
			  ...
			  reqBulan= $("#reqBulan").val();
			  reqTahun= $("#reqTahun").val();	
			  var url= "kenaikan_gaji_berkala_cetak_tanda_terima?reqSatuanKerjaId="+reqSatuanKerjaId+"&reqBulan="+reqBulan+'&reqTahun=' + reqTahun+'&reqJenisKgb='+reqJenisKgb;	
			  newWindow = window.open("app/loadUrl/app/"+url, 'Cetak');
			  newWindow.focus();	
		});
		...
		$("#reqStatusKgb,#reqJenisKgb").change(function() { 
			...
			oTable.fnReloadAjax("kenaikan_gaji_berkala_json/json?reqAkses=<?=$reqAkses?>&reqMode=&reqSatuanKerjaId="+reqSatuanKerjaId+"&reqStatusKgb="+reqStatusKgb+"&reqJenisKgb="+reqJenisKgb+"&reqPangkatId="+reqPangkatId+"&reqBulan="+reqBulan+"&reqTahun="+reqTahun+"&sSearch="+reqCariFilter);
		});
...
function selesai(pegawaiid)
{
	...
	$.ajax({'url': "kenaikan_gaji_berkala_json/getstatushitungulang/?reqPegawaiId="+pegawaiid+"&reqBulan="+reqBulan+"&reqTahun="+reqTahun,'success': function(dataJson) {
			   ...
			   buttons: [
				   {
					   ...
					   callback: function() {
						    $.ajax({'url': "kenaikan_gaji_berkala_json/addshortcut/?reqMode=updateselesai&reqStatusKgb=3&reqPegawaiId="+pegawaiid+"&reqBulan="+reqBulan+"&reqTahun="+reqTahun,'success': function(dataJson) {
								//var data= JSON.parse(dataJson);
	   ...
	   buttons: [
		   {
			   ...
			   callback: function() {
					...
					$.ajax({'url': "kenaikan_gaji_berkala_json/batal/?reqPegawaiId="+pegawaiid+"&reqBulan="+reqBulan+"&reqTahun="+reqTahun,'success': function(datahtml) {
						mbox.close();
						setCariInfo();
					}});
			   }
...
function setInfoTotal()
{
	...
	reqTahun= $("#reqTahun").val();
			// reqJenisKgb
	$.ajax({'url': "kenaikan_gaji_berkala_json/getinfototal/?reqSatuanKerjaId="+reqSatuanKerjaId+"&reqBulan="+reqBulan+"&reqTahun="+reqTahun,'success': function(dataJson) {
		var data= JSON.parse(dataJson);
...
<body>
			...
			<section id="content-full">
                ...
                <div id="bluemenu" class="bluetabs">
		            ...
		            <div id="dropmenu2_b" class="dropmenudiv_b" style="width: 250px; margin-top: -15px; margin-left: -25px">
						<!-- <a title="Cetak Usulan" onClick="windowOpenerPopup(350,450,'btncetakusulankgb','kenaikan_gaji_berkala_nominatif_excel.php?reqId=<?=$reqId?>&reqBulan='+$('#reqBulan').val()+'&reqTahun='+$('#reqTahun').val()+'&reqStatusAdministrasi='+$('#reqStatusAdministrasi').val());" >Cetak Nominatif</a>
						<a title="Cetak Tanda Terima" onClick="windowOpenerPopup(350,450,'btncetakusulankgb','kenaikan_gaji_berkala_tanda_terima_excel.php?reqId=<?=$reqId?>&reqBulan='+$('#reqBulan').val()+'&reqTahun='+$('#reqTahun').val()+'&reqStatusAdministrasi='+$('#reqStatusAdministrasi').val());" >Cetak Tanda Terima</a> -->
					    ...
					    <!-- 
					    <a title="Cetak SK KGB(Lengkap)" id="btnKgbLengkapRowPersonalKop">Cetak SK KGB(Lengkap) Personal</a>
					    <a title="Cetak SK KGB(Lengkap)" id="btnKgbLengkapRowKolektifKop">Cetak SK KGB(Lengkap) Kolektif</a>
					    <a title="Cetak SK KGB(Lengkap)" id="btnKgbLengkapRowPersonalCPNS">Cetak SK KGB Personal CPNS</a>
					    <a title="Cetak SK KGB(Lengkap)" id="btnKgbLengkapRowPersonal2016">Cetak SK KGB Personal (2016)</a> -->   
		            </div>
	...
	<script type="text/javascript">
        ...
        function cetakpengantartipejabatan(id, idttd, jenisid, tipeid, jabatanpilihan, jabatanmanual)
        {
          ...
          // var url= 'kenaikan_gaji_berkala_cetak_sk_rpt.php?reqJenis='+reqJenis+'&reqBulan='+$("#reqBulan").val()+'&reqTahun='+$("#reqTahun").val()+'&reqPegawaiId='+id+'&reqPegawaiPilihKepalaId='+idttd+"&reqTipeId="+tipeid+"&reqJabatanPilihan="+jabatanpilihan+"&reqJabatanManual="+reqJabatanManual;
		  // newWindow = window.open("app/loadUrl/app/"+url, 'Cetak');
		  
          var url= 'template?reqJenis='+reqJenis+'&reqBulan='+$("#reqBulan").val()+'&reqTahun='+$("#reqTahun").val()+'&reqPegawaiId='+id+'&reqPegawaiPilihKepalaId='+idttd+"&reqTipeId="+tipeid+"&reqJabatanPilihan="+jabatanpilihan+"&reqJabatanManual="+reqJabatanManual+'&reqLink=kenaikan_gaji_berkala_cetak_sk_pdf';
          newWindow = window.open("app/loadUrl/report/"+url, 'Cetak');
		  newWindow.focus();
        }
