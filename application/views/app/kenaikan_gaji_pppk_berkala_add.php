            ...
            for($index_loop=0; $index_loop < $jumlah_menu; $index_loop++)
            {
                ...
                ?>
                    ...
                    if($tempLinkDetilFile == "")
                    {
						...
						{
						?>
                        mainFrame.location.href='app/loadUrl/app/<?=$tempLinkFile?>/?reqPegawaiId=<?=$reqPegawaiId?>&reqPeriode=<?=$reqPeriode?>&reqBulan=<?=$reqBulan?>&reqTahun=<?=$reqTahun?>';
						<?
						}
						else
						{
						?>
						mainFrame.location.href='app/loadUrl/app/<?=$tempLinkFile?>/?reqId=<?=$reqPegawaiId?>&reqPeriode=<?=$reqPeriode?>';
						<?
						}
						?>
						iframeLoaded();
                    ...
                    else
                    {
                        ...
                        mainFrame.location.href='app/loadUrl/app/<?=$tempLinkFile?>/?reqId=<?=$reqPegawaiId?>&reqPeriode=<?=$reqPeriode?>';
						iframeLoaded();
                        //mainFrameDetil.location.href='app/loadUrl/app/<?=$tempLinkDetilFile?>/?reqPegawaiId=<?=$reqPegawaiId?>';
...
<body id="layouts-horizontal">
        ...
        <!-- start header nav-->
          ...
          <div id="main">
            ...
            <div class="wrapper">
              ...
              <!--start container-->
              <div class="container">
                <iframe src="app/loadUrl/app/<?=$arrMenu[0]["LINK_FILE"]?>/?reqPegawaiId=<?=$reqPegawaiId?>&reqBulan=<?=$reqBulan?>&reqTahun=<?=$reqTahun?>" name="mainFrame" id="mainFrame" onload="iframeLoaded()" style="border: none; width:100%" scrolling="no"></iframe>
              </div>
              <!--end container-->
          </section>
          <!-- END CONTENT -->
  ...
  <script type="text/javascript">
    ...
    <script type="text/javascript">
		...
		{
			$("iframe#mainFrame")[0].contentWindow.setdatasurat(id);
		}
