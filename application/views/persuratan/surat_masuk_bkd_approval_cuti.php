...
<head>
	...
	<script type="text/javascript" charset="utf-8">
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 25,
        	...
        	"bProcessing": true,
        	"bServerSide": true,
        	"sAjaxSource": "cuti_baru_json/dataapproval?",
        	"sScrollX": "100%",								  
        	"sScrollXInner": "100%",
		...
		$("#btnCari").on("click", function () {
			...
			oTable.fnReloadAjax("cuti_baru_json/dataapproval?&sSearch="+reqCariFilter);
		});
                ...
                <div id="bluemenu" class="bluetabs">
                    <ul>
                        <li>
                            ...
                            <a id="btnEdit" title="Approval"><img src="images/icon-edit.png" /> Approval</a>
                        </li>
                    </ul>
                </div>
